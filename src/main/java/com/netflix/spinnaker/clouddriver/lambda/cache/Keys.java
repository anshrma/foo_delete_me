...
public class Keys implements KeyParser {
  ...
  public static String getLambdaFunctionKey(String account, String region, String clusterName) {
    return buildKey(Namespace.LAMBDA_NAME.ns, account, region, clusterName);
  }
