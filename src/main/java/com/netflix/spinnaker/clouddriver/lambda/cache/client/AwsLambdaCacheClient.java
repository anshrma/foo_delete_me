...
public class AwsLambdaCacheClient extends AbstractCacheClient<AwsLambdaCacheModel>{
  ...
  protected AwsLambdaCacheModel convert(CacheData cacheData) {
    ...
    awsLambdaCacheModel.setFunctionName(attributes.get("lambdaFunctionName").toString());
    awsLambdaCacheModel.setFunctionName(attributes.get("lambdaFunctionArn").toString());
    awsLambdaCacheModel.setAccountName(attributes.get("account").toString());
